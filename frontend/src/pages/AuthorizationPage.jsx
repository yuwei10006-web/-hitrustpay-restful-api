...
import { getMerchantConfig, startAuthorization } from '../api/paymentApi';
import AppLayout from '../components/AppLayout';
import '../pages/Checkout.css';

export default function AuthorizationPage() {
  const form = useOrderForm({ defaultOrderDesc: 'API 串接測試' });
  ...
  return (
    <AppLayout title="信用卡交易授權" subtitle="填寫交易參數並發起授權">
